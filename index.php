...
$msg=0;
 ...
 if (isset($_POST['login'])) {
    ...
    if(empty($error)){
        ...
        $query= "SELECT `id`, `fname`, `lname`,  `email`, `password`, `status`, `role`, `phon_no`, `dep_id` FROM `users` WHERE email='$email';";
        ...
        $error= "user name  is required";
            ...
            $error= "ooops! invalid email format";
            }
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>ORG</b>Conference</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in now to org conference</p>
