...
if (isset($_POST['save'])) {
    ...
    $abriv= $_POST['abriv'];
    if (empty($dpname)) {
        $error="oops sory name fild should not be empty";
    }elseif (empty($abriv)) {
        $error="oops sory abriviation fild should not be empty";
    }else {
        $insert="INSERT INTO `dep` (`id`, `name`, `abrviation`) VALUES (NULL, '$dpname', '$abriv')";
        $recive=mysqli_query($con,$insert);
        if ($insert) {
            
        $msg="Congrats department was successful added  ";

        }else {
        $error="opps! data was not successfuly added  ";
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
              ...
              <i class="fa fa-times"></i></button>
                  ...
                  <form class="form-validate form-horizontal " id="Add dp" method="post" action="#">
                    <div class="form-group ">
                      <label for="fullname" class="control-label col-lg-2">department name <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="name" name="name" type="text" />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="fullname" class="control-label col-lg-2">dep abriviation <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="abriv" name="abriv" type="text" />
                      </div>
